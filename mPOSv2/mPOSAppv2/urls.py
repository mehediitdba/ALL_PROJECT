...
urlpatterns = [
    path('', views.mPOSAppv2, name='mPOSAppv2'),
    path('m_services', views.m_services, name='m_services'),
    path('m_about', views.m_about, name='m_about'),
    path('m_contact', views.m_contact, name='m_contact'),
    ...
    path('category_setup_v', views.category_setup_v, name='category_setup_v'),
